...
def main():
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        ...
        f.write("This file contains the outputs generated by the fine-tuned `Qwen2.5-1.5B-Instruct` model (using LoRA) on 10 hand-curated prompts across three modes: Tutor, Examiner, and Critic.\n\n")
        f.write("## Inference Settings\n")
        f.write("- **Model ID**: `Qwen/Qwen2.5-1.5B-Instruct`\n")
        f.write("- **Adapter Path**: `models/qwen_genai_tutor_lora`\n")
